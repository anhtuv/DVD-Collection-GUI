public class ElectronicStoreCreator {
    ...
    public static ElectronicStore createStore2(){
        ...
        Fridge f1 = new Fridge(350, 10, 250, "Black", "Sub Zero", false);
        Fridge f2 = new Fridge(600, 10, 125, "White", "Sub Zero", true);
        ToasterOven t1 = new ToasterOven(25, 10, 50, "Graphite", "Danby", false);
        ToasterOven t2 = new ToasterOven(75, 10, 50, "Red", "Toasty",  true);
        store1.addProduct(d1);
        store1.addProduct(d2);
        store1.addProduct(l1);
        store1.addProduct(l2);
    ...
    public static ElectronicStore createStore3(){
        ...
        Fridge f1 = new Fridge(250, 5, 250, "Black", "Sub Zero", false);
        Fridge f2 = new Fridge(275, 5, 125, "White", "Sub Zero", false);
        ToasterOven t1 = new ToasterOven(30, 10, 50, "Graphite", "Danby", false);
        ToasterOven t2 = new ToasterOven(80, 10, 50, "Red", "Toasty",  true);
        ...
        Fridge f3 = new Fridge(250, 5, 250, "Black", "Sub Zero", false);
        Fridge f4 = new Fridge(275, 5, 125, "White", "Sub Zero", false);
        ToasterOven t3 = new ToasterOven(30, 10, 50, "Graphite", "Danby", false);
        ToasterOven t4 = new ToasterOven(80, 10, 50, "Red", "Toasty", true);
        store1.addProduct(d1);
        store1.addProduct(d2);
        store1.addProduct(l1);
        store1.addProduct(l2);
